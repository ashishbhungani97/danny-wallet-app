...
import {black, white} from '../../component/common/LMStyle';
...
export default function BottomTabBarNavigator() {
  ...
  return (
    <Tab.Navigator
      tabBarOptions={{
        style: {backgroundColor: black, borderTopColor: '#202020'},
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({focused}) => <Swap focused={focused} />,
        }}
      />
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({focused}) => <Contact focused={focused} />,
        }}
      />
    </Tab.Navigator>
  );
