...
import {black, gray, white} from '../../component/common/LMStyle';
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <View style={styles.menuTitle}>
            <Text style={styles.menuText}>{lang.personal}</Text>
          </View>
        ...
        <TouchableOpacity
          ...
          <View style={styles.menuTitle}>
            <Text style={styles.menuText}>{lang.privacyAndSecurity}</Text>
          </View>
          <View style={styles.menuIcon}>
            <ChevronRight />
          </View>
        ...
        <TouchableOpacity
          ...
          <View style={styles.menuTitle}>
            <Text style={styles.menuText}>{lang.network}</Text>
          </View>
          <View style={styles.menuIcon}>
            <ChevronRight />
          </View>
        ...
        <TouchableOpacity style={styles.menuItem}>
          <View style={styles.menuTitle}>
            <Text style={styles.menuText}>{lang.help}</Text>
          </View>
          <View style={styles.menuIcon}>
            <ChevronRight />
          </View>
        ...
        <Text
          style={{position: 'absolute', bottom: 0, color: gray, fontSize: 10}}>
  ...
  return (
    <Drawer.Navigator
      ...
      drawerContent={props => {
        ...
        return (
          <LMGradient style={{flex: 1}}>
            <DrawerContent {...props} lang={lang} />
          </LMGradient>
        );
      }}>
      <Drawer.Screen name="Screens">
        {props => {
          return (
            <MainStackNavigator {...props} lang={lang} style={animatedStyle} />
          );
        }}
      </Drawer.Screen>
    </Drawer.Navigator>
