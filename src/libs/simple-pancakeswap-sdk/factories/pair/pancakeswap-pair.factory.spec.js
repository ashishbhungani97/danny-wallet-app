...
describe('PancakeswapPairFactory', () => {
  ...
  describe('erc20 > erc20', () => {
    const pancakeswapPairFactoryContext = {
      fromToken: (0, bat_token_mock_1.MOCKBAT)(),
      toToken: (0, uni_token_mock_1.MOCKUNI)(),
      ethereumAddress: (0, ethereum_address_mock_1.MockEthereumAddress)(),
      settings: new __1.PancakeswapPairSettings(),
      ethersProvider,
    };
    const pancakeswapPairFactory = new __1.PancakeswapPairFactory(
    ...
    describe('findAllPossibleRoutesWithQuote', () => {
      it('should return all possible routes with quotes', async () => {
        const result =
          await pancakeswapPairFactory.findAllPossibleRoutesWithQuote('1');
        expect(result).not.toBeUndefined();
      });
    });
    ...
    describe('hasGotEnoughAllowance', () => {
      ...
      it('should return false if i do not have enough allowance', async () => {
        const factory = new __1.PancakeswapPairFactory({
          fromToken: (0, uni_token_mock_1.MOCKUNI)(),
          toToken: (0, bat_token_mock_1.MOCKBAT)(),
          ethereumAddress: (0, ethereum_address_mock_1.MockEthereumAddress)(),
          settings: new __1.PancakeswapPairSettings(),
          ethersProvider,
        });
    ...
    describe('generateApproveMaxAllowanceData', () => {
      it('should generate the approve max allowance data', async () => {
        const result =
          await pancakeswapPairFactory.generateApproveMaxAllowanceData();
      ...
      it('should generate the approve max allowance data', async () => {
        await expect(
          ...
          new __1.PancakeswapError(
            ...
            __1.ErrorCodes.generateApproveMaxAllowanceDataNotAllowed,
          ),
        );
      });
    });
