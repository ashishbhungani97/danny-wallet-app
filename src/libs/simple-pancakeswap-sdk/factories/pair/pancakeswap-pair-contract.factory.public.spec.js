...
describe('PancakeswapPairContractFactoryPublic', () => {
    const pancakeswapPairContractFactoryPublic = new __1.PancakeswapPairContractFactoryPublic();
    it('allPairs', async () => {
    ...
    it('createPair', () => {
        const result = pancakeswapPairContractFactoryPublic.createPair((0, bat_token_mock_1.MOCKBAT)().contractAddress, __1.BNB.token().contractAddress);
    ...
    it('getPair', async () => {
        const result = await pancakeswapPairContractFactoryPublic.getPair(__1.BNB.token().contractAddress, (0, bat_token_mock_1.MOCKBAT)().contractAddress);
        expect(result).toEqual('0xD72AE03Be5ce45bB6FdFE0AA0D81d7eef709dCC3');
    });
    it('setFeeTo', async () => {
        const result = await pancakeswapPairContractFactoryPublic.setFeeTo('0x05B0c1D8839eF3a989B33B6b63D3aA96cB7Ec142');
        expect(result).toEqual('0xf46901ed00000000000000000000000005b0c1d8839ef3a989b33b6b63d3aa96cb7ec142');
    });
    it('setFeeToSetter', async () => {
        const result = await pancakeswapPairContractFactoryPublic.setFeeToSetter('0x05B0c1D8839eF3a989B33B6b63D3aA96cB7Ec142');
