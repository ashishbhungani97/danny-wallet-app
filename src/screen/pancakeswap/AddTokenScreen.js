      ...
      <SafeAreaView style={styles.container}>
            ...
            <Controller
              ...
              render={({onChange, onBlur, value}) => (
                <LMTextInput
                  ...
                  placeholder={lang.tokenContractAddress}
                  labelStyle={{color: primary}}
                  onEndEditing={async () => {
                    if (!(await TokenService.isExist(value))) {
                      const token = await PancakeswapModule.getToken(value);
        ...
        <View style={[styles.buttonsContainer, {marginBottom: 5}]}>
          <LMButton
            ...
            backgroundColor={error != 'Save' ? gray : undefined}
          />
        </View>
      </SafeAreaView>
    </Root>
