...
export default function PersonalScreen({navigation, lang}) {
  ...
  const {languages, defaultLanguage, language} = useSelector(
          ...
          <View style={styles.block}>
            ...
            <TouchableOpacity
              ...
              <View style={styles.selectContent}>
                <Flag id={defaultLanguage.icon} size={0.13} />
